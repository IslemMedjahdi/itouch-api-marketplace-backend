...
class ApiDto:
    ...
    create_api_version_request = api.model('create_api_version',{
        ...
        'headers': fields.List(fields.Nested(api.model('api_header', {
            'key': fields.String(required=True, description='The header key'),
            'value': fields.String(required=True, description='The header value')
        })), required=True, description='List of headers associated with the API version'),
        'endpoints': fields.List(fields.Nested(api.model('api_endpoint', {
            'url': fields.String(required=True, description='The endpoint url'),
            'method': fields.String(required=True, description='The endpoint method'),
            'description': fields.String(required=True, description='The endpoint description'),
