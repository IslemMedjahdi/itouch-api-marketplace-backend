...
class UserDto:
                ...
                api.model(
                    "single_user_info_data",
                    {
                        ...
                        "avatar": fields.String(
                            description="The user avatar", nullable=True
                        ),
                    },
                )
            ),
    ...
    suspend_user_response = api.model(
    ...
    activate_user_response = api.model(
    ...
    new_supplier_response = api.model(
        "new_supplier_response",
        {
            "status": fields.String(description="The status of the response"),
            "message": fields.String(description="The message of the response"),
        },
    )
    new_user_request = api.model(
        "new_user_request",
        {
            "email": fields.String(required=True, description="The email address"),
            "password": fields.String(required=True, description="The user password"),
    ...
    update_user_response = api.model(
        "updated_user_info",
        {
            "data": fields.Nested(
                api.model(
                    "updated_user_info_data",
                    {
                        "id": fields.Integer(description="The user ID"),
                        #'email': fields.String(description='The email address'),
                        "firstname": fields.String(description="The user firstname"),
    ...
    update_password_request = api.model(
        "update_password_request",
        {
            "current_password": fields.String(
                required=True, description="The user current password"
            ),
    ...
    update_password_response = api.model(
